...
export default function HeroContent({
  ...
  subtitle = "Ship products faster with AI-powered tools that understand your vision. No complex setup needed—just describe what you want and watch it come to life.",
  primaryLabel,
  primaryHref,
  primaryOnClick,
  secondaryLabel,
  ...
  backgroundImageOpacity = "opacity-40",
  showBorderFrame = true,
}) {
  return (
    <div className="relative flex min-h-screen w-full flex-col justify-end px-8 pt-32 pb-16 md:px-16 md:pt-40 md:pb-24">
      ...
      {backgroundImage && (
        <div className="pointer-events-none absolute inset-4 overflow-hidden md:inset-10">
          <Image
            ...
            fill
            priority
            className={`object-cover object-center ${backgroundImageOpacity}`}
            style={{
              maskImage:
